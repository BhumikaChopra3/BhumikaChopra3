...
//		System.out.println(kOrderedLCSRec(s1, s2, k, 0, 0));
	...
	private static int kOrderedLCSRec(String s1, String s2, int k, int vidx1, int vidx2) {
	...
	private static int kOrderedLCSTD(String s1, String s2, int k, int vidx1, int vidx2, int[][][] strg) {
	...
	private static int kOrderedLCSBU(String s1, String s2, int tk) {
