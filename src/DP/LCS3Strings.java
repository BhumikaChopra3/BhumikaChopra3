...
//		System.out.println(LCS3StringsREc(s1, s2, s3, 0, 0, 0));
	...
	private static int LCS3StringsREc(String s1, String s2, String s3, int vidx1, int vidx2, int vidx3) {
	...
	private static int LCS3StringsTD(String s1, String s2, String s3, int vidx1, int vidx2, int vidx3, int[][][] strg) {
	...
	private static int LCS3StringsBU(String s1, String s2, String s3) {
